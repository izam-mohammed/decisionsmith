...
outputs of real runs where the hardware allowed it.
...
| [05_multilingual_heads](05_multilingual_heads.ipynb) | `laya:multilingual` + head-only training (laya#320) | laptop or GPU | real run, Laya multilingual on Apple MPS |
